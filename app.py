...
with open('scaler_data.pkl','rb') as file:
...
# User input
geography = st.selectbox('Geography', encoder_geography.categories_[0])
...
geo_encoded = encoder_geography.transform([[geography]]).toarray()
